...
Objects0=../build-$(ConfigurationName)/PECL1/NodoArbol.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/PECL1/ArbolUrgencia.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/PECL1/main.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/PECL1/paciente.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/PECL1/NodoPila.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/PECL1/PilaPacientes.cpp$(ObjectSuffix) 
